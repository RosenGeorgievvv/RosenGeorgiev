...
const Skills = () => {
  return (
    <div className="container mx-auto" id="skills">
      ...
      <motion.div initial="hidden" whileInView="visible" variants={containerVars} viewport={{ once: true }} className="mx-2 flex flex-col rounded-3xl px-4 py-2 lg:px-20 border border-stone-50/30">
